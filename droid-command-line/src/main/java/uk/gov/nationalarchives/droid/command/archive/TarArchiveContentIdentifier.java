...
public class TarArchiveContentIdentifier {
    ...
    public TarArchiveContentIdentifier (BinarySignatureIdentifier binarySignatureIdentifier,
    ...
    public void identify(URI uri, IdentificationRequest request)
        ...
        String newPath = "tar:" + path + request.getFileName() + "!" + slash;
...
//                        System.out.println(".......found file: " + name);
                        ...
                        TarEntryIdentificationRequest tarRequest =
                            new TarEntryIdentificationRequest(metaData, identifier, tmpDir);
                        try {
                            tarRequest.open(in);
                            IdentificationResultCollection tarResults =
                                binarySignatureIdentifier.matchBinarySignatures(tarRequest);
          //                  System.out.println("tarRequest results: " + tarResults.getResults().size());
